...
Spreedly.DEFAULT_PROTOCOL = process.env.SPREEDLY_PROTOCOL || 'https'
Spreedly.DEFAULT_HOST = process.env.SPREEDLY_DEFAULT_HOST || 'core.spreedly.com';
Spreedly.DEFAULT_PORT = process.env.SPREEDLY_DEFAULT_PORT || '443';
Spreedly.DEFAULT_BASE_PATH = process.env.SPREEDLY_DEFAULT_BASE_PATH || '/v1';
...
function Spreedly(environmentKey, accessSecret, version) {
    ...
    this._api = {
        auth: null,
        protocol: Spreedly.DEFAULT_PROTOCOL,
